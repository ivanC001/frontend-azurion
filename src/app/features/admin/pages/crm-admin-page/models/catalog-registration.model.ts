...
export type CatalogTypeGroupCode = 'BIENES' | 'SERVICIOS' | 'PERSONAS' | 'INFRAESTRUCTURA' | 'OTROS';
...
export const CATALOG_TYPE_GROUPS: readonly CatalogTypeGroup[] = [
  { code: 'BIENES', label: 'Bienes y activos', description: 'Productos físicos, vehículos, inmuebles, equipos y producción.' },
  { code: 'SERVICIOS', label: 'Servicios y proyectos', description: 'Trabajo profesional, implementaciones y soluciones empresariales.' },
  { code: 'PERSONAS', label: 'Personas y experiencias', description: 'Formación, salud, viajes, hospitalidad y protección.' },
  { code: 'INFRAESTRUCTURA', label: 'Infraestructura y finanzas', description: 'Financiamiento, conectividad y soluciones energéticas.' },
  { code: 'OTROS', label: 'Otros rubros', description: 'Ofertas que todavía no encajan en una categoría específica.' },
] as const;
...
export const CATALOG_REGISTRATION_TYPES: readonly CatalogRegistrationType[] = [
  {
    ...
    descriptionPlaceholder: 'Describe qué incluye el producto, sus beneficios y la presentación ofrecida.',
    fields: [
      { key: 'categoria', label: 'Categoría', placeholder: 'Repuesto, alimento, ropa...', required: true },
      ...
      { key: 'unidadMedida', label: 'Unidad de venta', placeholder: 'Selecciona una unidad', type: 'select', required: true, options: ['Unidad', 'Caja', 'Paquete', 'Kilogramo', 'Litro', 'Metro', 'Otro'] },
    ],
  },
  {
    value: 'VEHICULO',
    ...
    descriptionPlaceholder: 'Resume equipamiento, condición, garantía, disponibilidad y condiciones comerciales.',
    fields: [
      { key: 'operacion', label: 'Operación', placeholder: 'Selecciona la operación', type: 'select', required: true, options: ['Venta', 'Alquiler', 'Financiamiento', 'Separación'] },
      ...
      { key: 'combustible', label: 'Combustible / energía', placeholder: 'Selecciona', type: 'select', options: ['Gasolina', 'Diésel', 'GLP', 'GNV', 'Híbrido', 'Eléctrico'] },
    ],
  },
  {
    value: 'INMUEBLE',
    ...
    descriptionPlaceholder: 'Describe distribución, acabados, servicios, antigüedad y condiciones de la operación.',
    fields: [
      { key: 'operacion', label: 'Operación', placeholder: 'Selecciona', type: 'select', required: true, options: ['Venta', 'Alquiler', 'Anticresis', 'Alquiler temporal'] },
      { key: 'tipoInmueble', label: 'Tipo de inmueble', placeholder: 'Selecciona', type: 'select', required: true, options: ['Casa', 'Departamento', 'Terreno', 'Oficina', 'Local comercial', 'Almacén', 'Otro'] },
      { key: 'ubicacion', label: 'Ubicación', placeholder: 'Distrito, ciudad o dirección', required: true, wide: true },
  ...
  },
  {
    ...
    descriptionPlaceholder: 'Indica capacidad, accesorios, estado, garantía y condiciones de entrega u operación.',
    fields: [
      { key: 'operacion', label: 'Operación', placeholder: 'Selecciona', type: 'select', required: true, options: ['Venta', 'Alquiler', 'Mantenimiento', 'Repuesto'] },
      { key: 'equipo', label: 'Tipo de equipo', placeholder: 'Excavadora, compresora...', required: true },
      ...
      { key: 'condicion', label: 'Condición', placeholder: 'Selecciona', type: 'select', options: ['Nuevo', 'Seminuevo', 'Usado', 'Reacondicionado'] },
  ...
  },
  {
    ...
    descriptionPlaceholder: 'Describe especificaciones, tolerancias, acabados y condiciones de fabricación.',
    fields: [
      { key: 'tipoProducto', label: 'Tipo de producto', placeholder: 'Pieza, lote, estructura...', required: true },
      { key: 'material', label: 'Material principal', placeholder: 'Acero, plástico, tela...' },
      { key: 'unidadMedida', label: 'Unidad comercial', placeholder: 'Selecciona', type: 'select', required: true, options: ['Unidad', 'Lote', 'Kilogramo', 'Metro', 'Metro cuadrado', 'Tonelada'] },
      ...
      { key: 'personalizacion', label: 'Admite personalización', placeholder: 'Selecciona', type: 'select', options: yesNoOptions },
    ],
  },
  {
    value: 'AGRICULTURA',
    ...
    descriptionPlaceholder: 'Describe aplicación, rendimiento, recomendaciones y cobertura geográfica.',
    fields: [
      { key: 'tipoOferta', label: 'Tipo de oferta', placeholder: 'Selecciona', type: 'select', required: true, options: ['Insumo', 'Semilla', 'Producto cosechado', 'Riego', 'Maquinaria', 'Servicio técnico', 'Otro'] },
      ...
      { key: 'unidadMedida', label: 'Unidad de venta', placeholder: 'Selecciona', type: 'select', required: true, options: ['Unidad', 'Saco', 'Kilogramo', 'Tonelada', 'Hectárea', 'Servicio'] },
      { key: 'coberturaZona', label: 'Zona de cobertura', placeholder: 'Provincia, región o valle' },
  ...
  },
  {
    ...
    descriptionPlaceholder: 'Explica alcance, actividades incluidas, exclusiones y resultado esperado.',
    fields: [
      { key: 'tipoServicio', label: 'Tipo de servicio', placeholder: 'Instalación, mantenimiento...', required: true },
      { key: 'modalidad', label: 'Modalidad', placeholder: 'Selecciona', type: 'select', required: true, options: modalityOptions },
      { key: 'duracion', label: 'Duración estimada', placeholder: '2 horas, 3 días, mensual' },
      { key: 'incluyeMateriales', label: 'Incluye materiales', placeholder: 'Selecciona', type: 'select', options: yesNoOptions },
  ...
  },
  {
    ...
    priceHelp: 'Registra un monto inicial; el presupuesto final puede definirse tras el diagnóstico.',
    descriptionPlaceholder: 'Resume objetivo, alcance, fases, supuestos y criterios de aceptación.',
    fields: [
      { key: 'tipoProyecto', label: 'Tipo de proyecto', placeholder: 'Obra, implementación, evento...', required: true },
      { key: 'alcance', label: 'Alcance principal', placeholder: 'Qué se ejecutará y hasta dónde', type: 'textarea', required: true, wide: true },
      { key: 'entregable', label: 'Entregable principal', placeholder: 'Sistema operativo, obra terminada...' },
  ...
  },
  {
    ...
    descriptionPlaceholder: 'Explica módulos, límites, soporte, implementación e integraciones incluidas.',
    fields: [
      { key: 'modalidad', label: 'Modelo comercial', placeholder: 'Selecciona', type: 'select', required: true, options: ['SaaS', 'Licencia perpetua', 'Desarrollo a medida', 'Implementación', 'Soporte'] },
      { key: 'solucion', label: 'Solución / módulos', placeholder: 'CRM, POS, inventario...', required: true },
      { key: 'usuarios', label: 'Usuarios incluidos', placeholder: '10', type: 'number', min: 1 },
      { key: 'periodicidad', label: 'Periodicidad', placeholder: 'Selecciona', type: 'select', options: ['Mensual', 'Trimestral', 'Anual', 'Pago único', 'Por proyecto'] },
      { key: 'plataforma', label: 'Plataforma', placeholder: 'Web, móvil, escritorio, API' },
      { key: 'incluyeImplementacion', label: 'Incluye implementación', placeholder: 'Selecciona', type: 'select', options: yesNoOptions },
    ],
  },
  {
    value: 'MARKETING',
    ...
    descriptionPlaceholder: 'Describe objetivos, canales, entregables, frecuencia de reportes y exclusiones.',
    fields: [
      { key: 'servicio', label: 'Tipo de servicio', placeholder: 'Ads, branding, contenidos...', required: true },
      { key: 'canal', label: 'Canal principal', placeholder: 'Selecciona', type: 'select', required: true, options: ['Meta Ads', 'Google Ads', 'TikTok', 'LinkedIn', 'SEO', 'Email', 'Multicanal', 'Otro'] },
      ...
      { key: 'presupuestoPauta', label: 'Pauta sugerida', placeholder: '0.00', type: 'number', min: 0, step: 0.01 },
      { key: 'entregables', label: 'Entregables', placeholder: 'Piezas, campañas, reportes...', wide: true },
    ],
  },
  {
    value: 'JURIDICO',
    ...
    descriptionPlaceholder: 'Describe alcance profesional, documentos incluidos, etapas y exclusiones.',
    fields: [
      { key: 'materia', label: 'Materia legal', placeholder: 'Selecciona', type: 'select', required: true, options: ['Civil', 'Laboral', 'Corporativo', 'Tributario', 'Penal', 'Familia', 'Administrativo', 'Otro'] },
      { key: 'tipoServicio', label: 'Tipo de servicio', placeholder: 'Consulta, contrato, proceso...', required: true },
      { key: 'jurisdiccion', label: 'Jurisdicción', placeholder: 'Ciudad, país o entidad' },
      { key: 'modalidad', label: 'Modalidad', placeholder: 'Selecciona', type: 'select', options: ['Presencial', 'Remoto', 'Mixto'] },
      { key: 'plazoEstimado', label: 'Plazo estimado', placeholder: '15 días, por etapa...' },
      { key: 'incluyeRepresentacion', label: 'Incluye representación', placeholder: 'Selecciona', type: 'select', options: yesNoOptions },
    ],
  },
  {
    value: 'CONSULTORIA',
    ...
    fields: [
      { key: 'area', label: 'Área de consultoría', placeholder: 'Procesos, ventas, finanzas...', required: true },
      { key: 'modalidad', label: 'Modalidad', placeholder: 'Selecciona', type: 'select', options: ['Presencial', 'Remoto', 'Híbrido'] },
      { key: 'alcance', label: 'Alcance', placeholder: 'Diagnóstico, diseño e implementación', type: 'textarea', required: true, wide: true },
  ...
  },
  {
    ...
    fields: [
      { key: 'area', label: 'Área temática', placeholder: 'Ofimática, ventas, tecnología...', required: true },
      { key: 'duracion', label: 'Duración', placeholder: '40 horas, 3 meses', required: true },
      { key: 'modalidad', label: 'Modalidad', placeholder: 'Selecciona', type: 'select', required: true, options: ['Virtual', 'Presencial', 'Híbrido', 'Autoguiado'] },
      { key: 'horario', label: 'Horario', placeholder: 'Sábados, noche, flexible' },
      { key: 'fechaInicio', label: 'Fecha de inicio', placeholder: '', type: 'date' },
      { key: 'certificacion', label: 'Incluye certificación', placeholder: 'Selecciona', type: 'select', options: yesNoOptions },
    ],
  },
  {
    value: 'EDUCACION',
    ...
    descriptionPlaceholder: 'Describe plan formativo, requisitos de ingreso, certificación y beneficios.',
    fields: [
      { key: 'programa', label: 'Tipo de programa', placeholder: 'Carrera, diplomado, academia...', required: true },
      { key: 'nivel', label: 'Nivel', placeholder: 'Inicial, básico, avanzado...' },
      { key: 'modalidad', label: 'Modalidad', placeholder: 'Selecciona', type: 'select', required: true, options: ['Virtual', 'Presencial', 'Híbrido'] },
  ...
  },
  {
    ...
    descriptionPlaceholder: 'Describe qué incluye el servicio, duración, preparación y restricciones generales.',
    fields: [
      { key: 'especialidad', label: 'Especialidad', placeholder: 'Dental, dermatología...', required: true },
      { key: 'tipoAtencion', label: 'Tipo de atención', placeholder: 'Selecciona', type: 'select', required: true, options: ['Consulta', 'Evaluación', 'Tratamiento', 'Procedimiento', 'Paquete', 'Control'] },
      { key: 'tratamiento', label: 'Tratamiento / servicio', placeholder: 'Nombre del procedimiento' },
      ...
      { key: 'requiereEvaluacion', label: 'Requiere evaluación previa', placeholder: 'Selecciona', type: 'select', options: yesNoOptions },
    ],
  },
  {
    value: 'SEGURO',
    ...
    fields: [
      { key: 'tipoSeguro', label: 'Tipo de seguro', placeholder: 'Selecciona', type: 'select', required: true, options: ['Vehicular', 'Salud', 'Vida', 'Hogar', 'Empresarial', 'Viaje', 'Otro'] },
      { key: 'cobertura', label: 'Plan / cobertura', placeholder: 'Todo riesgo, básico, premium', required: true },
      { key: 'vigencia', label: 'Vigencia', placeholder: 'Mensual, 1 año' },
      { key: 'sumaAsegurada', label: 'Suma asegurada referencial', placeholder: '0.00', type: 'number', min: 0, step: 0.01 },
      { key: 'requiereEvaluacion', label: 'Requiere evaluación de riesgo', placeholder: 'Selecciona', type: 'select', options: yesNoOptions },
    ],
  },
  {
    value: 'TURISMO',
    ...
    descriptionPlaceholder: 'Describe itinerario, alojamiento, traslados, comidas, entradas y exclusiones.',
    fields: [
      { key: 'tipoPaquete', label: 'Tipo de oferta', placeholder: 'Selecciona', type: 'select', required: true, options: ['Paquete', 'Tour', 'Hospedaje', 'Traslado', 'Experiencia', 'Circuito'] },
      ...
      { key: 'personasBase', label: 'Personas incluidas', placeholder: '2', type: 'number', min: 1 },
      { key: 'fechaDisponible', label: 'Fecha disponible', placeholder: '', type: 'date' },
      { key: 'incluye', label: 'Incluye', placeholder: 'Hotel, traslados, desayunos...', wide: true },
    ],
  },
  {
    value: 'HOSPITALIDAD',
    ...
    descriptionPlaceholder: 'Describe capacidad, ambientes, alimentación, equipamiento y políticas de reserva.',
    fields: [
      { key: 'servicio', label: 'Tipo de servicio', placeholder: 'Selecciona', type: 'select', required: true, options: ['Habitación', 'Restaurante', 'Evento', 'Salón', 'Catering', 'Experiencia'] },
      ...
      { key: 'incluye', label: 'Servicios incluidos', placeholder: 'Desayuno, equipos, estacionamiento...', wide: true },
    ],
  },
  {
    value: 'FINANCIERO',
    ...
    descriptionPlaceholder: 'Explica destino, perfil, condiciones, costos, evaluación y desembolso.',
    fields: [
      { key: 'productoFinanciero', label: 'Tipo de producto', placeholder: 'Selecciona', type: 'select', required: true, options: ['Crédito', 'Factoring', 'Leasing', 'Inversión', 'Cuenta', 'Seguro financiero', 'Otro'] },
      { key: 'moneda', label: 'Moneda', placeholder: 'Selecciona', type: 'select', required: true, options: ['PEN', 'USD', 'EUR', 'Otra'] },
      { key: 'montoMinimo', label: 'Monto mínimo', placeholder: '0.00', type: 'number', min: 0, step: 0.01 },
      { key: 'montoMaximo', label: 'Monto máximo', placeholder: '0.00', type: 'number', min: 0, step: 0.01 },
      { key: 'plazo', label: 'Plazo', placeholder: '12 meses' },
      { key: 'tasaReferencial', label: 'Tasa referencial (%)', placeholder: '0.00', type: 'number', min: 0, step: 0.01 },
      { key: 'requisitos', label: 'Requisitos principales', placeholder: 'Antigüedad, ventas, garantías...', type: 'textarea', wide: true },
    ],
  },
  {
    ...
    fields: [
      { key: 'servicio', label: 'Tipo de servicio', placeholder: 'Selecciona', type: 'select', required: true, options: ['Internet', 'Telefonía', 'Enlace dedicado', 'Central virtual', 'Equipos', 'Soporte'] },
      { key: 'tecnologia', label: 'Tecnología', placeholder: 'Selecciona', type: 'select', options: ['Fibra óptica', 'Radioenlace', '4G/5G', 'Satelital', 'Cobre', 'Otra'] },
      { key: 'velocidad', label: 'Velocidad / capacidad', placeholder: '500 Mbps' },
      { key: 'cobertura', label: 'Zona de cobertura', placeholder: 'Dirección, ciudad o región', required: true },
  ...
  },
  {
    ...
    descriptionPlaceholder: 'Describe dimensionamiento, equipos, instalación, ahorro esperado y garantía.',
    fields: [
      { key: 'solucion', label: 'Tipo de solución', placeholder: 'Selecciona', type: 'select', required: true, options: ['Solar fotovoltaica', 'Sistema eléctrico', 'Mantenimiento', 'Auditoría energética', 'Respaldo / UPS', 'Otro'] },
      ...
      { key: 'modalidad', label: 'Modalidad comercial', placeholder: 'Selecciona', type: 'select', options: ['Venta', 'Proyecto llave en mano', 'Servicio', 'Alquiler'] },
  ...
  },
  {
    ...
    descriptionPlaceholder: 'Describe claramente qué se vende, a quién está dirigido y qué incluye.',
    fields: [
      { key: 'categoria', label: 'Categoría', placeholder: 'Tipo de oferta', required: true },
      { key: 'modalidad', label: 'Modalidad de entrega', placeholder: 'Venta, alquiler, suscripción...' },
      { key: 'detalle', label: 'Características principales', placeholder: 'Información necesaria para vender esta oferta', type: 'textarea', required: true, wide: true },
...
export function catalogRegistrationType(type: CatalogOpportunityType): CatalogRegistrationType {
  return CATALOG_REGISTRATION_TYPES.find((item) => item.value === type) ?? CATALOG_REGISTRATION_TYPES[0];
}
